...
if (isset($groupID)) {
	if ($groupID==0) {
		...
		<form class=\"loggerDeleteForm\" id=\"loggerDeleteForm\" action=\"loggerDeleteResult.php\" method=\"post\">		
		<table>
		<tr>
		<td >Logger IP(*)</td>
		<td >:</td>
		...
		<td ></td>
		<td ></td>
		<td ><input name=\"formname\" type=\"hidden\" id=\"formname\" value=\"loggerDeleteForm\" /></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
